...
import { User, Mail, Lock, BookOpen, Mic, Users as CommunityIcon } from 'lucide-react';
      ...
      <div className="w-full max-w-4xl mx-auto bg-white dark:bg-dark-card rounded-xl shadow-md overflow-hidden grid md:grid-cols-2">
        ...
        <div className="p-8 md:p-12 flex flex-col justify-center">
            <div className="md:hidden text-center mb-8">
                <Logo to="/register" className="h-14 inline-block" />
            </div>
            <h1 className="text-4xl font-bold text-primary text-center md:text-left">Create Your Account</h1>
            <p className="text-gray-600 dark:text-dark-subtext mt-2 mb-6 text-center md:text-left">Join our community and start your journey.</p>
